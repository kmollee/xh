<?php
	...
	$pluginloader_tx['menu']['tab_main'] = "Main Settings";
	$pluginloader_tx['menu']['tab_css'] = "Stylesheet";
	$pluginloader_tx['menu']['tab_config'] = "Config";
	$pluginloader_tx['menu']['tab_language'] = "Language";
	$pluginloader_tx['menu']['tab_help'] = "Help";
